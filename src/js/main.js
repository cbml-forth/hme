...
var _user$project$Graph$maybesToList = function (l) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (m, acc) {
...
var _user$project$Graph$connectionsOfNode = F2(
	function (nodeId, graph) {
		var conns = _elm_lang$core$Dict$values(graph.connections);
		return A2(
			_elm_lang$core$List$filter,
			function (conn) {
				return _elm_lang$core$Native_Utils.eq(conn.sourceId, nodeId) || _elm_lang$core$Native_Utils.eq(conn.targetId, nodeId);
			},
			conns);
	});
var _user$project$Graph$removeConnection = F2(
	function (connId, oldG) {
		return _elm_lang$core$Native_Utils.update(
			oldG,
			{
				connections: A2(_elm_lang$core$Dict$remove, connId, oldG.connections)
			});
	});
var _user$project$Graph$addConnection = F2(
	function (conn, oldG) {
		return _elm_lang$core$Native_Utils.update(
			oldG,
			{
				connections: A3(_elm_lang$core$Dict$insert, conn.id, conn, oldG.connections)
			});
	});
var _user$project$Graph$removeNode = F2(
	function (nodeId, oldG) {
		return _elm_lang$core$Native_Utils.update(
			oldG,
			{
				nodes: A2(_elm_lang$core$Dict$remove, nodeId, oldG.nodes),
				connections: A2(
					_elm_lang$core$Dict$filter,
					F2(
						function (id, c) {
							return (!_elm_lang$core$Native_Utils.eq(c.sourceId, nodeId)) && (!_elm_lang$core$Native_Utils.eq(c.targetId, nodeId));
						}),
					oldG.connections)
			});
	});
var _user$project$Graph$addNode = F2(
	function (node, oldG) {
		return _elm_lang$core$Native_Utils.update(
			oldG,
			{
				nodes: A3(_elm_lang$core$Dict$insert, node.id, node, oldG.nodes)
			});
	});
var _user$project$Graph$newNodeId = function (graph) {
	var newId = graph.idGen + 1;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toString(newId),
		_1: _elm_lang$core$Native_Utils.update(
			graph,
			{idGen: newId})
	};
};
var _user$project$Graph$newNode = F2(
	function (kind, graph) {
		var _p1 = _user$project$Graph$newNodeId(graph);
		var newId = _p1._0;
		var newGraph = _p1._1;
		var node = {
			id: newId,
...
var _user$project$Graph$moveNode = F3(
	function (nodeId, pos, graph) {
		var maybeNode = A2(
			_elm_lang$core$Maybe$map,
			function (n) {
				return _elm_lang$core$Native_Utils.update(
		...
		if (_p5.ctor === 'Nothing') {
			...
			return A2(_user$project$Graph$addNode, _p5._0, graph);
		}
	});
var _user$project$Graph$neighborsOfNode = F2(
	function (nodeId, graph) {
		var conns = A2(_user$project$Graph$connectionsOfNode, nodeId, graph);
		var ids = A2(
			_elm_lang$core$List$map,
			function (conn) {
...
var _user$project$Graph_ops = _user$project$Graph_ops || {};
_user$project$Graph_ops[':::'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Graph$encodeNodeKind = function (_p6) {
	var _p7 = _p6;
...
var _user$project$Graph$encodePosition = function (_p8) {
	var _p9 = _p8;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'x',
				_1: _elm_lang$core$Json_Encode$int(_p9.x)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'y',
					_1: _elm_lang$core$Json_Encode$int(_p9.y)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Graph$encodeNode = function (_p10) {
	var _p11 = _p10;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(_p11.id)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p11.inPorts))
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_0: 'outPorts',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p11.outPorts))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'position',
							_1: _user$project$Graph$encodePosition(_p11.position)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'kind',
								_1: _user$project$Graph$encodeNodeKind(_p11.kind)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Graph$encodeConnection = function (_p12) {
	var _p13 = _p12;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(_p13.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'sourceId',
					_1: _elm_lang$core$Json_Encode$string(_p13.sourceId)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'sourcePort',
						_1: _elm_lang$core$Json_Encode$string(_p13.sourcePort)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'targetId',
							_1: _elm_lang$core$Json_Encode$string(_p13.targetId)
						},
						_1: {
							ctor: '::',
							_0: {
...
var _user$project$Graph$encodeGraph = function (_p14) {
	var _p15 = _p14;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
				_user$project$Graph_ops[':::'],
				'idGen',
				_elm_lang$core$Json_Encode$int(_p15.idGen)),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Graph_ops[':::'],
					'uuid',
					_elm_lang$core$Json_Encode$string(_p15.uuid)),
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
								_user$project$Graph$encodeNode,
								_elm_lang$core$Dict$values(_p15.nodes)))
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								A2(
									...
									_elm_lang$core$Dict$values(_p15.connections)))
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Graph$graphToJson = function (graph) {
	return A2(
...
var _user$project$Graph$Graph = F4(
	function (a, b, c, d) {
		return {nodes: a, connections: b, idGen: c, uuid: d};
	});
var _user$project$Graph$ModelNode = function (a) {
	return {ctor: 'ModelNode', _0: a};
};
var _user$project$Graph$nodeDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'kind',
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Graph$ModelNode)),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'position',
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Graph$Node))))));
var _user$project$Graph$graphDecoder = function () {
	var graphCtor = F4(
		function (idGen, uuid, nodes, conns) {
			var g1 = _user$project$Graph$newGraph(uuid);
			var g2 = _elm_lang$core$Native_Utils.update(
				g1,
				{idGen: idGen});
			var g3 = A3(
				_elm_lang$core$List$foldr,
				F2(
					function (n, g) {
						return A2(_user$project$Graph$addNode, n, g);
					}),
				g2,
				nodes);
			var g4 = A3(
				...
				F2(
					function (c, g) {
						return A2(_user$project$Graph$addConnection, c, g);
					}),
				g3,
				conns);
			return g4;
	...
	return A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'connections',
		_elm_lang$core$Json_Decode$list(_user$project$Graph$connectionDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'nodes',
			_elm_lang$core$Json_Decode$list(_user$project$Graph$nodeDecoder),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'uuid',
				_elm_lang$core$Json_Decode$string,
...
var _user$project$State$newUuid = function (state) {
	...
	var newUuid = _p0._0;
	var newSeed = _p0._1;
	var u_ = {currentUuid: newUuid, currentSeed: newSeed};
	return _elm_lang$core$Native_Utils.update(
		state,
		{uuid: u_});
};
var _user$project$State$findHypermodelByUUID = F2(
	function (uuid, list) {
		...
		while (true) {
			...
			if (_p1.ctor === '[]') {
				...
				var _p2 = _p1._0;
				if (_elm_lang$core$Native_Utils.eq(_p2.id, uuid)) {
					...
					uuid = _v1;
					list = _v2;
					continue findHypermodelByUUID;
				}
			}
		}
	});
var _user$project$State$findΜodelByUUID = F2(
	function (uuid, list) {
		findΜodelByUUID:
		while (true) {
			var _p3 = list;
			if (_p3.ctor === '[]') {
				...
				var _p4 = _p3._0;
				if (_elm_lang$core$Native_Utils.eq(_p4.uuid, uuid)) {
...
var _user$project$State$initModelSearch = {title: _elm_lang$core$Maybe$Nothing, frozenOnly: false, stronglyCoupledOnly: true, perspective1: _elm_lang$core$Maybe$Nothing};
var _user$project$State$modelIsUsed = F2(
	function (state, model) {
		var modelId = model.uuid;
		var nodes = _user$project$Graph$nodes(state.wip.graph);
		return A2(
			_elm_lang$core$List$any,
			function (n) {
				var _p6 = n.kind;
...
var _user$project$State$modelIsDynamic = function (model) {
	var hasDynamicPort = function (ports) {
		return A2(
			_elm_lang$core$List$any,
			function (_) {
				return _.isDynamic;
	...
	return hasDynamicPort(model.inPorts) || hasDynamicPort(model.outPorts);
};
var _user$project$State$emptyHypermodel = function (id) {
	return {
		title: '',
		id: id,
		description: '',
		...
		updated: _elm_lang$core$Date$fromTime(0),
		svgContent: '',
		graph: _user$project$Graph$newGraph(id)
	};
};
var _user$project$State$initializeState = function (state) {
	var state2 = _user$project$State$newUuid(state);
	var u = _danyx23$elm_uuid$Uuid$toString(
		function (_) {
			return _.currentUuid;
		}(
			function (_) {
				return _.uuid;
			}(state2)));
	return _elm_lang$core$Native_Utils.update(
		state2,
		{
			...
			busyMessage: 'Loading..',
			zoomLevel: 1.0,
			modelSearch: _user$project$State$initModelSearch
		});
};
var _user$project$State$newHypermodel = function (state) {
...
var _user$project$State$init = function (seed) {
	...
	var initialState = {
		...
		busyMessage: 'Loading..',
		zoomLevel: 1.0,
		uuid: {currentSeed: newSeed, currentUuid: newUuid},
		modelSearch: _user$project$State$initModelSearch,
		serverError: _elm_lang$core$Maybe$Nothing
	};
	return {ctor: '_Tuple2', _0: initialState, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$State$UUID = F2(
	function (a, b) {
		return {currentSeed: a, currentUuid: b};
	});
var _user$project$State$Hypermodel = F9(
...
var _user$project$State$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {title: a, id: b, uuid: c, description: d, frozen: e, inPorts: f, outPorts: g};
	});
var _user$project$State$ModelSearchState = F4(
	function (a, b, c, d) {
		return {title: a, frozenOnly: b, stronglyCoupledOnly: c, perspective1: d};
	});
...
var _user$project$Rest$encodeHypermodel = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'canvas',
							_1: _elm_lang$core$Json_Encode$string(_p1.canvas)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'graph',
								_1: _user$project$Graph$encodeGraph(_p1.graph)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'svg_content',
									_1: _elm_lang$core$Json_Encode$string(_p1.svgContent)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Rest$hypermodelDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'graph',
	_user$project$Graph$graphDecoder,
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'svgContent',
		_elm_lang$core$Json_Decode$string,
						...
						A4(
							...
							A3(
								...
								A3(
									...
									'title',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$State$Hypermodel))))))))));
var _user$project$Rest$boolFromInt = A2(
	_elm_lang$core$Json_Decode$map,
	function (i) {
...
var _user$project$Rest$modelDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'outPorts',
	_elm_lang$core$Json_Decode$list(_user$project$Rest$modelParamDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'inPorts',
		_elm_lang$core$Json_Decode$list(_user$project$Rest$modelParamDecoder),
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'freezed',
			_user$project$Rest$boolFromInt,
			false,
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'description',
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'title',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$State$Model))))))));
var _user$project$Rest$getResource = F2(
	function (url, decoder) {
		return A2(
...
var _user$project$Rest$saveResponseDecoder = A2(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$Rest$saveHyperModel = function (hypermodel) {
	return A2(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_elm_lang$core$Basics$identity,
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_user$project$Rest$saveResponseDecoder),
			A2(
...
var _user$project$Ports$modals = _elm_lang$core$Native_Platform.outgoingPort(
	'modals',
	function (v) {
		return {id: v.id, show: v.show};
	});
var _user$project$Ports$showOrHideModal = F2(
	function (b, modalId) {
		return _user$project$Ports$modals(
			{id: modalId, show: b});
	});
var _user$project$Ports$loadHypermodel = _elm_lang$core$Native_Platform.outgoingPort(
	'loadHypermodel',
	function (v) {
...
var _user$project$Ports$addNode = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			...
			name: v.name,
			ports: {
				inPorts: _elm_lang$core$Native_List.toArray(v.ports.inPorts).map(
					function (v) {
						return v;
					}),
				outPorts: _elm_lang$core$Native_List.toArray(v.ports.outPorts).map(
					function (v) {
						return v;
					}),
				dynPorts: _elm_lang$core$Native_List.toArray(v.ports.dynPorts).map(
					function (v) {
						return v;
					})
			},
...
var _user$project$Ports$addModelToGraph = F3(
	function (nodeId, position, model) {
		var dynPorts = A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.name;
		...
		var inPorts = A2(
			...
			model.inPorts);
		return _user$project$Ports$addNode(
			{
				id: nodeId,
				name: model.title,
...
var _user$project$Ports$scaleGraph = _elm_lang$core$Native_Platform.outgoingPort(
	'scaleGraph',
	function (v) {
		return v;
	});
var _user$project$Ports$serializeGraph = _elm_lang$core$Native_Platform.outgoingPort(
	'serializeGraph',
	function (v) {
		return null;
	});
var _user$project$Ports$newGraphSignal = _elm_lang$core$Native_Platform.incomingPort(
	'newGraphSignal',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (canvas) {
			return A2(
				...
				A2(_elm_lang$core$Json_Decode$field, 'svg', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'canvas', _elm_lang$core$Json_Decode$string)));
var _user$project$Ports$newConnectionSignal = _elm_lang$core$Native_Platform.incomingPort(
	'newConnectionSignal',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (id) {
					...
					return A2(
						...
						function (sourcePort) {
							return A2(
								...
								A2(_elm_lang$core$Json_Decode$field, 'targetId', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'sourcePort', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'sourceId', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string)));
var _user$project$Ports$moveNodeSignal = _elm_lang$core$Native_Platform.incomingPort(
	'moveNodeSignal',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (node) {
...
var _user$project$Ports$removeConnectionSignal = _elm_lang$core$Native_Platform.incomingPort('removeConnectionSignal', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$removeNodeSignal = _elm_lang$core$Native_Platform.incomingPort('removeNodeSignal', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$showNodeSignal = _elm_lang$core$Native_Platform.incomingPort('showNodeSignal', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$UIGraph = F2(
	function (a, b) {
		return {canvas: a, svg: b};
	});
var _user$project$Ports$MoveNode = F2(
	function (a, b) {
		return {ctor: 'MoveNode', _0: a, _1: b};
	});
var _user$project$Ports$ShowNode = function (a) {
	return {ctor: 'ShowNode', _0: a};
};
var _user$project$Ports$RemoveNode = function (a) {
	return {ctor: 'RemoveNode', _0: a};
};
var _user$project$Ports$RemoveConnection = function (a) {
	return {ctor: 'RemoveConnection', _0: a};
};
var _user$project$Ports$NewConnection = function (a) {
	return {ctor: 'NewConnection', _0: a};
};
var _user$project$Ports$NewGraph = function (a) {
	return {ctor: 'NewGraph', _0: a};
};
var _user$project$Ports$subscriptions = function (state) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$newGraphSignal(_user$project$Ports$NewGraph),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$newConnectionSignal(_user$project$Ports$NewConnection),
				_1: {
					ctor: '::',
					_0: _user$project$Ports$moveNodeSignal(
						function (_p0) {
							var _p1 = _p0;
							return A2(
								_user$project$Ports$MoveNode,
								_p1.node,
								{x: _p1.x, y: _p1.y});
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Ports$removeConnectionSignal(_user$project$Ports$RemoveConnection),
						_1: {
							ctor: '::',
							_0: _user$project$Ports$removeNodeSignal(_user$project$Ports$RemoveNode),
							_1: {
								ctor: '::',
								_0: _user$project$Ports$showNodeSignal(_user$project$Ports$ShowNode),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Msg$UIMsg = function (a) {
	return {ctor: 'UIMsg', _0: a};
};
var _user$project$Msg$ModelSearchStronglyCoupled = function (a) {
	return {ctor: 'ModelSearchStronglyCoupled', _0: a};
};
var _user$project$Msg$ModelSearchFrozen = function (a) {
	return {ctor: 'ModelSearchFrozen', _0: a};
};
var _user$project$Msg$ModelSearchTitle = function (a) {
	return {ctor: 'ModelSearchTitle', _0: a};
};
var _user$project$Msg$ChangeDescription = function (a) {
	return {ctor: 'ChangeDescription', _0: a};
};
var _user$project$Msg$ChangeTitle = function (a) {
	return {ctor: 'ChangeTitle', _0: a};
};
var _user$project$Msg$AddModel = function (a) {
	return {ctor: 'AddModel', _0: a};
};
var _user$project$Msg$OpenHypermodel = function (a) {
	return {ctor: 'OpenHypermodel', _0: a};
};
...
var _user$project$Msg$ReloadHypermodel = {ctor: 'ReloadHypermodel'};
...
var _user$project$View$viewHypermodel = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.id;
	var versionStr = _elm_lang$core$Basics$toString(_p1.version);
	var b = A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Msg$OpenHypermodel(_p2)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('ui right floated button'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('ui cloud download icon'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('ui small image'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-tooltip', _p2),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-position', 'right center'),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('middle aligned content'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
									...
									},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Nephroblastoma'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_user$project$View$viewDate(_p1.created),
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		' Updated : ',
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			_user$project$View$viewDate(_p1.updated),
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				' (version: ',
																				A2(_elm_lang$core$Basics_ops['++'], versionStr, ')'))))))),
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Server Error'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('ui cancel button'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Msg$CloseModal(modalWin)),
...
var _user$project$View$viewHypermodels = function (allHypermodels) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id(_user$project$View$modalWinIds.listHypermodels),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$i,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Msg$CloseModal(_user$project$View$modalWinIds.listHypermodels)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Available Hypermodels'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								A2(_elm_lang$core$List$map, _user$project$View$viewHypermodel, sortedHypermodels)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$viewSaveHypermodel = function (hm) {
	var modalId = _user$project$View$modalWinIds.saveHypermodel;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$i,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Msg$CloseModal(modalId)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(hm.title),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
										...
										},
										{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(hm.id),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
											...
											},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$ChangeTitle),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(hm.title),
																_1: {ctor: '[]'}
															}
														},
														{ctor: '[]'}),
												...
												},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$ChangeDescription),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(hm.description),
																	_1: {ctor: '[]'}
																}
															},
															{ctor: '[]'}),
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$DoSaveHypermodel),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$View$addClasses = function (l) {
	return A2(_elm_lang$core$String$join, ' ', l);
};
var _user$project$View$applyWhen = F3(
	function (b, f, thing) {
		return b ? f(thing) : thing;
	});
var _user$project$View$applyUnless = function (b) {
...
var _user$project$View$btnToButton = function (c) {
	var cls = _user$project$View$addClasses(
		{
			ctor: '::',
			_0: c.fitted ? 'fitted' : '',
			_1: {
				ctor: '::',
				_0: c.enabled ? '' : 'disabled',
				_1: {
					ctor: '::',
					_0: c.icon,
					_1: {
						ctor: '::',
						_0: 'icon orange button',
						_1: {ctor: '[]'}
					}
				}
			}
		});
	var tooltip = A2(_elm_lang$html$Html_Attributes$attribute, 'data-tooltip', c.title);
	var position = A2(_elm_lang$html$Html_Attributes$attribute, 'data-position', c.position);
	var attributes = {
		ctor: '::',
		_0: position,
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('compact ui button'),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$View$btnMsg = F2(
	function (m, c) {
		return _elm_lang$core$Native_Utils.update(
			c,
			{
				enabled: true,
				msg: _elm_lang$core$Maybe$Just(m)
			});
	});
var _user$project$View$btnIcon = F2(
	function (iconClass, c) {
		return _elm_lang$core$Native_Utils.update(
			c,
			{icon: iconClass});
	});
var _user$project$View$btnPosition = F2(
	function (pos, c) {
		return _elm_lang$core$Native_Utils.update(
			c,
			{position: pos});
	});
var _user$project$View$newBtn = F2(
	function (title, icon) {
		return {title: title, position: 'bottom left', fitted: true, icon: icon, enabled: false, msg: _elm_lang$core$Maybe$Nothing};
	});
var _user$project$View$toolbar = function (state) {
	var aBtn = F3(
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('ui right floated buttons'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Stelios'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$viewModel = F2(
	function (state, m) {
		var b = _user$project$View$btnToButton(
			A2(
				_user$project$View$btnMsg,
				_user$project$Msg$AddModel(m),
				A2(
					_user$project$View$btnPosition,
					'left center',
					A2(
						_user$project$View$newBtn,
						A2(_elm_lang$core$Basics_ops['++'], 'Add ', m.title),
						'Plus'))));
		var isStronglyCoupled = _user$project$State$modelIsDynamic(m);
		var isUsed = A2(_user$project$State$modelIsUsed, state, m);
		var styles = A2(
			_elm_lang$core$Basics_ops['++'],
			isStronglyCoupled ? {
				ctor: '::',
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$td,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'disabled', _1: isUsed},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'collapsing', _1: true},
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(m.title),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('collapsing'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$View$viewModels = F2(
	function (state, modelSearch) {
		...
		var modelsList = A2(
			...
			{ctor: '[]'},
			state.allModels);
		var models0 = modelSearch.stronglyCoupledOnly ? A2(_elm_lang$core$List$filter, _user$project$State$modelIsDynamic, modelsList) : modelsList;
		var models1 = modelSearch.frozenOnly ? A2(
			_elm_lang$core$List$filter,
			function (_) {
				return _.frozen;
			},
				...
				_0: A2(
					_elm_lang$html$Html$i,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msg$CloseModal(_user$project$View$modalWinIds.listModels)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Available Models'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('floating ui teal label'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(
														_elm_lang$core$List$length(models2))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
															...
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_user$project$Msg$ModelSearchTitle),
																			_1: {ctor: '[]'}
																		}
																	}
																}
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('ui checkbox'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$checked(modelSearch.frozenOnly),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onCheck(_user$project$Msg$ModelSearchFrozen),
																			_1: {ctor: '[]'}
																		}
																	}
																},
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Stable only'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
															...
															},
															{
																...
																_0: A2(
																	_elm_lang$html$Html$input,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$checked(modelSearch.stronglyCoupledOnly),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onCheck(_user$project$Msg$ModelSearchStronglyCoupled),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Strongly coupled only'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Perspective 1'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('ui dropdown'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('ui small celled striped padded table'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															A2(
																_elm_lang$core$List$map,
																_user$project$View$viewModel(state),
																models2)),
														_1: {ctor: '[]'}
													}
												}),
...
var _user$project$View$sidebar = function (state) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('ui thin left inverted vertical menu sidebar'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('home icon'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('block layout icon'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _user$project$View$view = function (state) {
	var loading = (_elm_lang$core$Native_Utils.cmp(state.pendingRestCalls, 0) > 0) || _krisajenkins$remotedata$RemoteData$isLoading(state.allModels);
	var loaderClasses = _user$project$View$addClasses(
		{
			ctor: '::',
			_0: loading ? 'active' : 'disabled',
			_1: {
				ctor: '::',
				_0: 'ui',
				_1: {
	...
	var title = A3(
		_user$project$View$applyWhen,
		A2(_elm_lang$core$Debug$log, 'DIRTY:', state.needsSaving),
		function (tt) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('ui'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$sidebar(state),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pusher'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _user$project$View$toolbar(state),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$View$viewHypermodels(state.allHypermodels),
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$viewModels, state, state.modelSearch),
							_1: {
								ctor: '::',
		...
		if (_p1.ctor === 'Err') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					newState,
					{
						serverError: _elm_lang$core$Maybe$Just(_p1._0)
					}),
				{
					ctor: '::',
...
var _user$project$Main$doLoadHypermodels = function (state) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_elm_lang$core$Native_Utils.update(
			state,
...
var _user$project$Main$loadHypermodel = F2(
	function (hm, allModels) {
		...
		var nodeToJson = function (_p5) {
			var _p6 = _p5;
			var _p7 = _p6.kind;
			return A2(
				_elm_lang$core$Maybe$map,
				A2(modelToJson, _p6.id, _p6.position),
				A2(_user$project$State$findΜodelByUUID, _p7._0, allModels));
		};
...
var _user$project$Main$startNewHypermodel = function (state) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Main$loadHypermodel, newState.wip, allModels),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$update = F2(
	function (m, state) {
		var _p8 = A2(_elm_lang$core$Debug$log, 'MSG:', m);
		switch (_p8.ctor) {
			case 'NewHypermodel':
				return _user$project$Main$startNewHypermodel(state);
			case 'LoadHypermodels':
				return _user$project$Main$doLoadHypermodels(state);
			case 'LoadModels':
				return _user$project$Main$showLoadedModels(state);
			...
			case 'CloseModal':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Ports$showOrHideModal, false, _p8._0),
						_1: {ctor: '[]'}
					});
			case 'OpenHypermodel':
				var allModels = A2(
					...
					{ctor: '[]'},
					state.allModels);
				var hm = A2(_user$project$State$findHypermodelByUUID, _p8._0, state.allHypermodels);
				var wip_ = function () {
					var _p18 = hm;
					if (_p18.ctor === 'Just') {
						return _p18._0;
				...
				return A2(
						...
						{needsSaving: false, showHypermodels: false, loadedHypermodel: hm, wip: wip_, zoomLevel: 1.0}),
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$loadHypermodel, wip_, allModels),
							_1: {ctor: '[]'}
						}
					});
			case 'ReloadHypermodel':
				var allModels = A2(
					_krisajenkins$remotedata$RemoteData$withDefault,
					{ctor: '[]'},
					state.allModels);
			...
			case 'SaveHypermodel':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Ports$showOrHideModal, true, _user$project$View$modalWinIds.saveHypermodel),
						_1: {ctor: '[]'}
					});
			case 'DoSaveHypermodel':
				var newState = _elm_lang$core$Native_Utils.update(
					state,
				...
				return A2(
					...
					state,
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Ports$serializeGraph(
								{ctor: '_Tuple0'}),
							_1: {ctor: '[]'}
						}
					});
			...
			case 'ChangeDescription':
				...
				return A2(
					...
					{ctor: '[]'});
			case 'ZoomIn':
				var state_ = _elm_lang$core$Native_Utils.update(
					state,
					{zoomLevel: state.zoomLevel + 0.2});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					state_,
					{
						ctor: '::',
						_0: _user$project$Ports$scaleGraph(state_.zoomLevel),
						_1: {ctor: '[]'}
					});
			case 'ZoomActualSize':
				var state_ = _elm_lang$core$Native_Utils.update(
			...
			case 'ModelSearchStronglyCoupled':
				var search = state.modelSearch;
				var search_ = _elm_lang$core$Native_Utils.update(
					search,
					{stronglyCoupledOnly: _p8._0});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						state,
...
var _user$project$Main$debugView = function (state) {
	return _user$project$View$view(
		A2(_elm_lang$core$Debug$log, 'New State:', state));
};
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Msg$UIMsg,
		_user$project$Ports$subscriptions(model));
};
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: A2(_Fresheyeball$elm_return$Return_ops['>>>'], _user$project$State$init, _user$project$Main$doLoadModels),
		update: _user$project$Main$update,
		subscriptions: _user$project$Main$subscriptions,
		view: _user$project$View$view
	})(_elm_lang$core$Json_Decode$int);

var _user$project$Uuid2$toString = _elm_lang$core$Basics$toString;
var _user$project$Uuid2$Uuid = function (a) {
	return {ctor: 'Uuid', _0: a};
};
var _user$project$Uuid2$uuidGenerator = A2(
	_mgold$elm_random_pcg$Random_Pcg$map,
	_user$project$Uuid2$Uuid,
	A2(_mgold$elm_random_pcg$Random_Pcg$int, _mgold$elm_random_pcg$Random_Pcg$minInt, _mgold$elm_random_pcg$Random_Pcg$maxInt));

var Elm = {};
Elm['Graph'] = Elm['Graph'] || {};
if (typeof _user$project$Graph$main !== 'undefined') {
    _user$project$Graph$main(Elm['Graph'], 'Graph', undefined);
}
Elm['Main'] = Elm['Main'] || {};
...
Elm['Uuid2'] = Elm['Uuid2'] || {};
if (typeof _user$project$Uuid2$main !== 'undefined') {
    _user$project$Uuid2$main(Elm['Uuid2'], 'Uuid2', undefined);
}
Elm['View'] = Elm['View'] || {};
